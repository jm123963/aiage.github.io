...
define('ICON_FONT_URL', '//at.alicdn.com/t/font_579509_kh0vbskfehcwhfr.css');
...
//    wp_enqueue_style( 'font-awesome', ICON_FONT_URL, array(), '1.0.0', 'all' );
    wp_enqueue_style( 'caomei-font', CS_URI.'/assets/caomei.css', array(), '1.0.0', 'all' );
